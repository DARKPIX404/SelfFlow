...
import com.selfflow.app.service.notification.NotificationSoundPlayer
...
fun SettingsScreen(
    ...
    val soundPlayer = remember { NotificationSoundPlayer(context) }
                ...
                Column(
                    ...
                    Row(
                        ...
                        NotificationSoundDropdown(
                            ...
                            onSelected = { viewModel.setNotificationSound(it) },
                            modifier = Modifier.weight(1f)
                        )
                        IconButton(
                            onClick = { soundPlayer.play(notificationSound) }
                        ) {
                            Icon(
...
private fun NotificationSoundDropdown(
    ...
    Box(modifier = modifier) {
        OutlinedTextField(
            ...
            onValueChange = {},
            readOnly = true,
            label = { Text(stringResource(R.string.notification_sound_label)) },
            trailingIcon = {
